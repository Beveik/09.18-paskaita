...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <?php 
                $sql = "SELECT reiksme FROM nustatymai WHERE ID = 2"; //mums priklauso ar dropdown rodo ar ne
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <?php 
                                ...
                                while($categories = mysqli_fetch_array($result)) {
                                    ...
                                    $id = $categories["ID"];
                                    echo "<a class='dropdown-item' href='vartotojas.php?catID=$id'>$pavadinimas</a>";
            ...
            <ul class="navbar-nav mr-auto">
                ...
                if($selected_value[0] == "rodyti") {?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <?php 
                                $sql = "SELECT pavadinimas, nuoroda FROM puslapiai WHERE rodyti = 1";
                                $result = $prisijungimas->query($sql);
                                ...
                                while($puslapiai = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<a class='dropdown-item' href='puslapiai.php?href=$nuoroda'>$pavadinimas</a>";
